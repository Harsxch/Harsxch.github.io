  ...
  return (
    <form action={formAction} className="space-y-3">
      <div className="grid grid-cols-3 gap-3">
        ...
        <div>
          <label className={labelClass}>Attach coupon (redirect appends couponCode)</label>
      ...
      <p className="text-xs font-semibold text-slate-900 uppercase tracking-wide pt-1">UTM parameters</p>
      <div className="grid grid-cols-3 gap-3">
        <div>
